...
questions = [
    ...
    {
        text: "The government belongs directly to vox populi.",
        category: "government",
        effect: -1
    },
    {
    ...
    {
        text: "Capitalism will eventually die out and be replaced by socialism, whether Marxist (revolution) or democratic (evolution).",
        category: "economic",
        effect: 1
    },
    {
        text: "I support an assault weapon ban similar to the one from 1994-2004",
        category: "government",
        effect: 1
    },
    {
        text: "As a general rule, equality is more important than freedom.",
        category: "cultural",
        effect: 1
    },
    {
    ...
    {
        text: "Domestic surveillance programs like the Patriot Act are important to protect our nation.",
        category: "government",
        effect: 1
    },
    {
        text: "It is important that we implement or continue affirmative action programs for the sake of equality.",
        category: "cultural",
        effect: 1
    },
    {
        text: "Wealth distributed according to the Pareto Principle would leave too much wealth inequality.",
        category: "economic",
        effect: 1
    }
]
